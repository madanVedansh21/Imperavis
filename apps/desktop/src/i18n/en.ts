...
export const en: Translations = {
  ...
  boot: {
    ...
    steps: {
      ...
      startingHermesDesktop: 'Starting OrgHumans…'
    },
    errors: {
      backgroundExited: 'OrgHumans background process exited.',
      backgroundExitedDuringStartup: 'OrgHumans background process exited during startup.',
    ...
    failure: {
      title: "OrgHumans couldn't start",
      description:
  ...
  notifications: {
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting OrgHumans.',
    ...
    native: {
      ...
      turnDoneTitle: 'OrgHumans finished',
  ...
  settings: {
    ...
    gateway: {
      ...
      intro:
        'OrgHumans starts its own local gateway by default. Use a remote gateway when you want this app to control an already-running Hermes backend on another machine or behind a trusted proxy. Pick a profile below to give it its own remote host.',
      ...
      cloudTitle: 'OrgHumans Cloud',
      cloudDesc: 'Sign in once to OrgHumans Cloud and pick from the agents on your account — no URL to paste.',
      cloudSignInTitle: 'OrgHumans Cloud',
      cloudSignIn: 'Sign in to OrgHumans Cloud',
      cloudSignedIn: 'Signed in to OrgHumans Cloud',
      cloudNeedsSignIn: 'Sign in to OrgHumans Cloud to discover the agents on your account.',
      ...
      cloudDiscoverFailed: 'Could not load your OrgHumans Cloud agents',
      cloudConnectFailed: 'Could not connect to that agent',
      cloudSignInFailed: 'OrgHumans Cloud sign-in failed',
      cloudSignedOutTitle: 'Signed out of OrgHumans Cloud',
      cloudSignedOutMessage: 'Cleared the OrgHumans Cloud session.',
      ...
      restartingMessage: 'OrgHumans will reconnect using the saved settings — the shell stays open.',
      ...
      sshErrPlatform:
        'Unsupported remote platform. OrgHumans SSH mode supports Linux, macOS, and Windows remote hosts.',
  ...
  commandCenter: {
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure OrgHumans' },
  ...
  updates: {
    ...
    guiSkewBody:
      'The backend was updated, but this desktop app package wasn’t changed. Update or reinstall the OrgHumans app (your AppImage / .deb / .rpm) to match.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody:
  ...
  install: {
    ...
    setupChoiceTitle: 'Set up OrgHumans',
    setupChoiceDesc:
      'Connect this app to an OrgHumans gateway you already run, or install OrgHumans locally on this computer.',
    connectExistingTitle: 'Connect to existing OrgHumans',
    ...
    installLocalTitle: 'Install OrgHumans locally',
    installLocalDesc: 'Download OrgHumans, create its Python environment, and run the backend on this computer.',
    localStartUnavailable: 'Local installation could not start. Restart OrgHumans and try again.',
    remoteSetupTitle: 'Connect to existing OrgHumans',
    remoteSetupDesc: 'Enter your gateway URL. OrgHumans will detect whether it needs a token or browser sign-in.',
    remoteUrlTitle: 'Gateway URL',
    remoteUrlDesc: 'Use the base URL of the OrgHumans gateway, including https:// when remote.',
    remoteUrlPlaceholder: 'https://gateway.example.com/hermes',
    probing: 'Detecting gateway authentication...',
    probeError: 'Could not reach that OrgHumans gateway.',
    identityProvider: 'your identity provider',
    authTitle: 'Authentication',
  ...
  shell: {
    ...
    statusbar: {
      ...
      desktopVersion: version => `OrgHumans v${version}`,
      backendVersion: version => `Backend v${version}`,
      clientLabel: version => `client v${version}`,
      connectionSsh: host => `SSH: ${host}`,
      connectionRemote: host => `Remote: ${host}`,
      connectionCloud: host => `Cloud: ${host}`,
      connectionCloudTooltip: host => `Connected to OrgHumans Cloud at ${host} · click to manage`,
  ...
  preview: {
    ...
    web: {
      ...
      finishedRestarting: message => `OrgHumans finished restarting the preview server${message ? `: ${message}` : ''}`,
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart OrgHumans to use Save Image.',
    restartToSaveImages: 'Restart OrgHumans to save images',
